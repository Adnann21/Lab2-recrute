...
namespace Recrute.Controllers
{
    public class CandidatesController : Controller
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            var list = await db.Candidat.Where(a=>a.RecrComp==rec.RecrComp).ToListAsync();
            if(list==null)
            {
        ...
        public async Task<IActionResult> Create([FromBody] Models.Candidate a, IFormFile cv)
        {
            try
            {
                ...
                {
                    Models.Candidate  b=new Models.Candidate() { 
                        Username = a.Username,
                        RecrComp = a.RecrComp,
                        Position = a.Position,
                        Review=a.Review,
        ...
        public async Task<IActionResult> Update(string username, [FromBody]Candidate a)
        {
            try
            {
                if (username == null)
                ...
                {
                    var b= db.Candidat.Where(a=>a.Username==username).FirstOrDefault();
        ...
        public async Task<IActionResult> Delete(String username)
        {
            ...
            try
            {
                ...
                {
                    var app = db.Candidat.Where(a => a.Username == username).FirstOrDefault();
